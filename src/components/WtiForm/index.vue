...
<style scoped lang="scss">
    .wti-form {
        ...
        ::v-deep .el-select .el-input.is-focus .el-input__inner, ::v-deep .el-textarea__inner:focus {
            border-color: #ABB3CC !important;
        }

        ::v-deep .wti-untext-box {
            height: 36px !important;
        }

        ::v-deep .checkbox-height {
    ...
    .wti-form-v2 ::v-deep input::-webkit-outer-spin-button,
    .wti-form-v2 ::v-deep input::-webkit-inner-spin-button {
        -webkit-appearance: none;
    }

    .wti-form-v2 ::v-deep input[type="number"] {
        -webkit-appearance: none;
        appearance: none;
    }
    ...
    .wti-form.wti-form-v2 {
        ::v-deep .el-form.el-form--label-top, .el-form--label-left {
            .el-form-item__label {
                justify-content: start;
            }
        }

        ::v-deep .child-form-container {
    ...
    .wti-form.wti-form-v2 {
        ::v-deep .el-form.el-form--label-right {
            .el-form-item__label {
                justify-content: end;
            }
        }
