<template>
  <div class="app-container">
    ...
    <el-table v-if="refreshTable" v-loading="loading" :data="menuList" row-key="menuId" :height="'calc(100vh - 205px)'"
...
export default {
  ...
  methods: {
    ...
    /** 查询菜单下拉树结构 */
    getTreeselect() {
      let queryParam = { sourceType: this.sourceType };
      listMenu(queryParam).then(response => {
        this.menuOptions = [];
