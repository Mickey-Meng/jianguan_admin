      ...
      <el-dialog :title="title" :visible.sync="open" width="1100px" append-to-body>
        ...
        <el-row>
            ...
            <el-form ref="form" :model="form" :rules="rules" label-width="150px">
              ...
              <el-row :gutter="20">
                <el-col :span="12">
                  <el-form-item label="付款进度" prop="attachmentProgress">
                    <el-input v-model="form.attachmentProgress" placeholder="请输入付款进度" />
                  </el-form-item>
                </el-col>

                <el-col :span="12">
                  <el-form-item label="产值进度" prop="productionProgress">
                    <el-input v-model="form.productionProgress" placeholder="请输入产值进度" />
                  </el-form-item>
                </el-col>
              </el-row>
                <el-row :gutter="20">
