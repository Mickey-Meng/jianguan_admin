...
import { getProduceLibraryTree, listProduceLibrary, getProduceLibrary, delProduceLibrary, addProduceLibrary, updateProduceLibrary } from "@/api/jianguan/produce/produceLibrary";
...
export default {
  ...
  methods: {
    ...
    getProduceLibraryTree() {
      getProduceLibraryTree().then(response => {
