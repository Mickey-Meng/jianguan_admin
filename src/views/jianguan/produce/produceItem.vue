  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="构建类型编码" prop="conponentTypeCode">
        <el-input
          v-model="queryParams.conponentTypeCode"
          placeholder="请输入构建类型编码"
          clearable
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['system:produce:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="produceList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="构建类型编码" align="center" prop="conponentTypeCode" />
      <el-table-column label="工序名称" align="center" prop="name" />
      <el-table-column label="" align="center" prop="rangee" />
      <el-table-column label="" align="center" prop="isvaild" />
