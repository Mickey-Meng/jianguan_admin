<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="ledgerBreakdownDetailList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="复核数量" align="center" prop="fhsl" />
      <el-table-column label="已计量数量" align="center" prop="yjlsl" />
      <el-table-column label="复核金额" align="center" prop="fhje" />
      <el-table-column label="状态" align="center" prop="fjlx">
