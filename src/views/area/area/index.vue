<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="" align="center" prop="Pid" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="" prop="Pid">
          <treeselect v-model="form.Pid" :options="areaOptions" :normalizer="normalizer" placeholder="请选择" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    /** 删除按钮操作 */
    handleDelete(row) {
      this.$modal.confirm('是否确认删除省市区编号为"' + row.Id + '"的数据项？').then(() => {
        this.loading = true;
